...
public class StatisticController {
    ...
    public StatisticResponseDto getDayStatsUser(
        @PathVariable(name = "user", required = true) String userID, 
    ...
    public StatisticResponseDto getMonthStatsUser(
    ...
    public StatisticResponseDto getDayStatsTeam(
        @PathVariable(name = "teamID", required = true) String teamID, 
        @PathVariable(name = "date", required = true) long date) {
    ...
    public StatisticResponseDto getStats(
        @PathVariable(name = "teamID", required = true) String teamID, 
        @PathVariable(name = "start", required = true) long start,
        @PathVariable(name = "end", required = true) long end) {
